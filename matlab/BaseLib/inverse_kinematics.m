function [angles1,angles2] = inverse_kinematics(distance, theta)
    % parameters
    l2 = 25.42;
    l3 = 217;
    ...
    angle1=atand(l2./(distance-l1));
    angle2=acosd(((distance-l1).^2+l2^2+l4^2-l3^2)./(2*sqrt((distance-l1).^2+l2^2)*l4));
    motor_angles = angle1 + angle2;
    angles1 = motor_angles+theta;
    angles2 = -motor_angles+theta;
end